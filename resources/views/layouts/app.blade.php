...
<head>
    ...
    <title>Admin T1 - @yield('title')</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        /* Semua CSS dari template Anda tetap sama */
        :root {
            --primary: #3b5998;
            --secondary: #6d84b4;
            --success: #4caf50;
        ...
        /* ... (seluruh CSS dari template Anda) ... */
    </style>
</head>
<body>
    <!-- Sidebar -->
    ...
    <script>
        ...
        function confirmDelete(event) {
            if (!confirm('Apakah Anda yakin ingin menghapus proyektor ini?')) {

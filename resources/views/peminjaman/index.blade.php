...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="#"><i class="fas fa-list me-1"></i> Daftar Peminjaman</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fas fa-calendar-alt me-1"></i> Kalender</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mb-5">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <h2 class="mb-0"><i class="fas fa-list text-primary me-2"></i> Daftar Peminjaman</h2>
                <p class="text-muted">Kelola semua peminjaman ruangan dan proyektor</p>
            </div>
                    ...
                    <div class="col-md-8">
                        <div class="search-container">
                            ...
                            <input type="text" class="form-control search-input"
                                placeholder="Cari berdasarkan ruang, keperluan...">
                        </div>
                    </div>
                    <div class="col-md-4">
                            ...
                            <td>
                                @if ($peminjaman->proyektor)
                                    <span class="badge bg-success status-badge"><i class="fas fa-check me-1"></i>
                                        Ya</span>
                                @else
                                    <span class="badge bg-secondary status-badge"><i class="fas fa-times me-1"></i>
                                        Tidak</span>
                                @endif
                            </td>
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty-state">
                                    ...
                                    <p class="text-muted">Silahkan tambah data peminjaman baru dengan menekan tombol
                                        "Tambah Peminjaman"</p>
                                </div>
                            </td>
                        </tr>
    ...
    <script>
        ...
        function confirmDelete(e) {
            ...
            if (confirm('Apakah Anda yakin ingin menghapus data peminjaman ini?')) {
                // gunakan e.currentTarget agar selalu ambil <a>, bukan <i>
                window.location.href = e.currentTarget.href;
            }
        }

        // Menambahkan event listener untuk semua tombol hapus
        ...
        // Debug: Tampilkan nilai status dari setiap baris
